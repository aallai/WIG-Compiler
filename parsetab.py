...
_lr_goto_items = {'attribute':([66,67,68,81,],[81,81,81,81,]),'variables':([12,98,],[20,105,]),'argument':([63,90,],[75,75,]),'htmls':([3,5,],[6,8,]),'neattributes':([66,67,68,81,],[83,83,83,94,]),'nehtmlbodies':([36,52,97,],[55,69,104,]),'fieldvalue':([144,210,],[180,180,]),'schemas':([6,],[12,]),'nestms':([105,124,],[111,145,]),'functions':([20,],[30,]),'neexps':([142,207,],[173,223,]),'service':([0,],[1,]),'compoundstm':([89,91,105,124,201,205,234,],[99,101,110,110,213,110,110,]),'htmlbody':([36,52,97,],[52,52,52,]),'field':([27,39,],[39,39,]),'html':([3,5,],[5,5,]),'arguments':([63,],[76,]),'input':([204,233,],[220,220,]),'document':([116,125,],[138,146,]),'type':([12,20,25,32,63,90,98,],[19,31,19,31,77,77,19,]),'nefieldvalues':([144,210,],[177,177,]),'schema':([6,11,],[11,11,]),'function':([20,32,],[32,32,]),'inputs':([204,],[217,]),'nefields':([27,39,],[37,57,]),'nevariables':([12,25,98,],[17,35,17,]),'sessions':([30,43,],[45,60,]),'stms':([105,],[117,]),'neinputs':([204,233,],[219,238,]),'neschemas':([6,11,],[10,15,]),'attributes':([66,67,68,],[82,86,87,]),'variable':([12,25,98,],[25,25,25,]),'plugs':([202,228,],[216,235,]),'plug':([202,228,],[214,214,]),'simpletype':([12,20,25,27,32,39,63,90,98,],[16,16,16,40,16,40,16,16,16,]),'attr':([66,67,68,81,93,],[80,80,80,80,102,]),'nearguments':([63,90,],[74,100,]),'receive':([138,],[170,]),'fields':([27,],[38,]),'identifiers':([19,41,183,186,],[29,59,211,212,]),'stm':([105,124,205,234,],[124,124,222,239,]),'exps':([142,],[174,]),'session':([30,43,],[43,43,]),'exp':([105,108,113,115,124,127,133,134,141,142,147,149,151,152,153,154,155,156,158,159,160,161,162,163,205,207,209,229,234,],[126,132,135,136,126,164,167,168,172,175,182,185,188,189,190,191,192,193,194,195,196,197,198,199,126,175,224,236,126,]),'lvalue':([105,108,113,115,124,127,133,134,141,142,147,149,151,152,153,154,155,156,158,159,160,161,162,163,204,205,207,209,229,233,234,],[112,112,112,112,112,112,112,112,112,112,112,112,112,112,112,112,112,112,112,112,112,112,112,112,218,112,112,112,112,218,112,]),'nefunctions':([20,32,],[33,47,]),'fieldvalues':([144,210,],[178,225,]),}
...
_lr_productions = [
  ...
  ('stm -> WHILE ( exp ) compoundstm','stm',5,'p_while','parser.py',344),
